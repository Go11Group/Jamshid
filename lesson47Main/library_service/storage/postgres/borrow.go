...
func (b *BorrowRepository) Create(borrow *pb.CreateBorrowRequest) error {
...
func (b *BorrowRepository) GetById(id *pb.ByIdRequest) (*pb.BorrowResponse, error) {
...
func (b *BorrowRepository) Update(borrow *pb.UpdatedBorrowRequest) error {
...
func (b *BorrowRepository) Delete(id *pb.ByIdRequest) error {
...
func (b *BorrowRepository) GetAll(f *pb.BorrowFilterRequest) (*pb.BorrowsResponse, error) {
	var (
